...
- **Migrar alguma coisa deste repositório.** A mídia dele segue arquivo; a demanda
  [governança em issues neste repo](../concluidas/governanca-em-issues-neste-repo.md) é outra.
...
- **Promoção (passo 3)** — a lição do `midia.md` virou regra no `CLAUDE.md`: referência que o
  ...
  ([o setup não avisa que o Matt pergunta o mesmo](o-setup-nao-avisa-que-o-matt-pergunta-o-mesmo.md),
